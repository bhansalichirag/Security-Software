		...
		<div class="col-md-12" id="page-content" align="center">
			<div class="panel panel-primary">
 				 ...
 				 <div class="panel-body" align="center">
					<form class="form-horizontal" id="ScheduleAppointment" action="/appointment" method="post">
			  			<fieldset>
			  				<div class="form-group">
						      <label for="select" class="col-lg-2 control-label">Reason for the Appointment</label>
						      <div class="col-lg-5">
